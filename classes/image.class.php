	...
	private function getImageSize()
	{
		...
		case 18:
			...
			if (function_exists('imagecreatefromwebp')) {
				$this->imageIdentifier	= imagecreatefromwebp($this->srcImage);
			} else {
				throw new Exception('Application Error. WebP not supported!');
			}
			break;
		case 6:
			$this->srcType	= 'bmp';
			if (function_exists('imagecreatefrombmp')) {
				$this->imageIdentifier	= imagecreatefrombmp($this->srcImage);
			} else {
				throw new Exception('Application Error. BMP not supported!');
			}
			break;
		default:
			throw new Exception('Application Error. Invalid Image Type! ('.$imageData['2'].')');
		}
	}
