...
$sql            = "SELECT COUNT(CID) AS total_messages FROM wall_comments WHERE WID = " .$uid. " AND status = '1'";
$rsc            = $conn->execute($sql);
$total          = $rsc->fields['total_messages'];
$pagination     = new Pagination(10);
$limit          = $pagination->getLimit($total);
$sql            = "SELECT w.CID, w.WID, w.UID, w.message, w.addtime, u.username, u.photo, u.gender
