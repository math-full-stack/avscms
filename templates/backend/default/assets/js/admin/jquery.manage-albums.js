    ...
    $("body").on('click', "button[id='add-photos-update']", function(event) {
		...
		$("input[id*='photo_added_caption_']").each(function () {
			...
			if (caption != '') {
				...
				$.post(base_url + '/ajax.php?module=admin_update_caption', {data: captionData },
					function (response) {
						if (response.status) {
							//success message
						}
...
$(document).ready(function(){
    ...
    $("body").on('click', "a[id='view_del_album']", function(event) {
		...
		$.post(base_url + '/ajax.php?module=admin_delete_album', { album_id: album_id },
			function (response) {
				if (response.status) {
					Messenger().post({
    ...
    $("body").on('click', "a[id='view_del_photo']", function(event) {
		...
		$.post(base_url + '/ajax.php?module=admin_delete_photo', { photo_id: photo_id },
			function (response) {
				if (response.status) {
					Messenger().post({
    ...
    $("body").on('click', "a[id*='unflag_photo_']", function(event) {
		...
		$('#' + id).html('<i class="small-loader"></i>');
		$.post(base_url + '/ajax.php?module=admin_unflag_photo', { f_id: f_id },
			function (response) {
				if (response.status) {
					Messenger().post({
    ...
    $("body").on('click', "a[id*='thumb_album_']", function(event) {
		...
		if (processing == 0) {
			...
			$.post(base_url + '/ajax.php?module=admin_thumb_album', { album_id: album_id },
				function (response) {
					if (response.status) {
						Messenger().post({
    ...
    $("body").on('click', "a[id*='status_album_']", function(event) {
		...
		if (processing == 0) {
			...
			var album_id = split[2];
			$('#' + id).html('<i class="small-loader"></i>');
			$.post(base_url + '/ajax.php?module=admin_status_album', { album_id: album_id, album_status: album_status},
				function (response) {
					if (response.status) {
						if (album_status == 0) {
							Messenger().post({
    ...
    $("body").on('click', "a[id*='view_album_']", function(event) {
		...
		$.post(base_url + '/ajax.php?module=admin_get_photos_album', { album_id: album_id, start: -1 },
			function (response) {				
    ...
    $("body").on('click', "a[id*='edit_album_']", function(event) {
		...
		$.post(base_url + '/ajax.php?module=admin_get_album', { album_id: album_id },
			function (response) {
				if (response.status) {
					//Reset Errors
	...
	$("body").on('click', "button[id='edit-save']", function(event) {		
		...
		if (!hasErrors("input[id*='edit-']") && !hasErrors("textarea[id*='edit-']")) {
			...
			$.post(base_url + '/ajax.php?module=admin_save_album', { data: albumData },
				function (response) {					
    ...
    $("body").on('click', "a[id*='cover_album_']", function(event) {
		...
		$.post(base_url + '/ajax.php?module=admin_get_photos_album', { album_id: album_id, start: 0 },
			function (response) {				
	...
	$("body").on('click', "button[id*='cover-np-']", function(event) {		
		...
		$.post(base_url + '/ajax.php?module=admin_get_photos_album', { album_id: album_id, start: start},
			function (response) {	
	...
	$("body").on('click', "button[id='cover-save']", function(event) {		
		...
		//save code	
		$('#cover_album_' + album_id).html('<i class="small-loader"></i>');		
		$.post(base_url + '/ajax.php?module=admin_save_cover', { album_id: album_id, photo_id: photo_id, x1: x1, y1: y1, x2: x2, y2: y2, iw: iw, ih: ih },
			function (response) {
    ...
    $("body").on('click', "a[id*='status_photo_']", function(event) {
		...
		if (processing == 0) {
			...
			var photo_id = split[2];
			$('#' + id).html('<i class="small-loader"></i>');
			$.post(base_url + '/ajax.php?module=admin_status_photo', { photo_id: photo_id, photo_status: photo_status},
				function (response) {
					if (response.status) {
						if (photo_status == 0) {
							Messenger().post({
    ...
    $("body").on('click', "a[id*='edit_photo_']", function(event) {
		...
		$.post(base_url + '/ajax.php?module=admin_get_photo', { photo_id: photo_id },
			function (response) {
				if (response.status) {
					//Reset Errors
					$('.form-control').each(function(){
	...
	$("body").on('click', "button[id='photo-edit-save']", function(event) {		
		...
		if (!hasErrors("input[id*='photo-edit-']")) {
			...
			$.post(base_url + '/ajax.php?module=admin_save_photo', { data: photoData },
				function (response) {					
