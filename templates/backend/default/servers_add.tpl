						...
						<form class="form-no-horizontal-spacing" name="addServer" method="POST" action="servers.php?m=add">
							<div class="row">
								<div class="col-lg-8 col-lg-offset-2 col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<div class="radio p-t-9">
												<input id="type_ftp" type="radio" name="server_type" value="ftp" {if $server.server_type != 'gcs'}checked="checked"{/if} class="radio-enabled">
									...
									<!-- ========== GCS FIELDS ========== -->
									<div id="fields_gcs" style="display: none;">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input class="form-control" name="gcs_key_path" id="srv_gcs_key" type="text" value="{$server.gcs_key_path|escape:'html'}" placeholder="configs/service-account.json">
												<span class="help">Caminho absoluto ou relativo ao arquivo JSON da Service Account do Google Cloud.<br>
												Exemplo absoluto: <code>/home/user/keys/service-account.json</code><br>
												Exemplo relativo: <code>configs/gcs-key.json</code> (relativo ao diretório do projeto)</span>
											</div>
											<div class="clearfix"></div>
										</div>
										...
										<div class="form-group">
											<div class="col-lg-8 col-lg-offset-4">
												<div class="alert alert-info" style="margin-bottom: 0;">
													<i class="fa fa-info-circle"></i> <b>Como configurar:</b><br>
													1. Crie um bucket no <a href="https://console.cloud.google.com/storage" target="_blank">Google Cloud Console</a><br>
													2. Crie uma Service Account com permissão <b>Storage Object Admin</b><br>
													3. Baixe a chave JSON e faça upload para o servidor<br>
													4. O arquivo deve estar acessível pelo PHP (caminho correto)
												</div>
											</div>
											<div class="clearfix"></div>
										</div>
									...
									<div class="form-group">
										<div class="col-lg-8 col-lg-offset-4">
											<button type="button" id="btn_test_ftp" class="btn btn-info btn-cons">
												<i class="fa fa-plug"></i> <span id="btn_test_ftp_text">Testar Conexão</span>
											</button>
										</div>
										<div class="clearfix"></div>
									</div>
