...
$(document).ready(function(){
    ...
    $("a[id*='photo_favorite']").click(function(event) {
        ...
        $.post(base_url + '/ajax.php?module=favorite_photo', { photo_id: photo_id, album_id: album_id},
        function (response) {
    ...
    $("button[id='submit_flag_photo']").click(function(event) {
        ...
        $.post(base_url + '/ajax.php?module=flag_' + type, { item_id: item_id, flag_id: flag_id, message: message },
        function(response) {
