...
if ($video['embed_code'] == '') {
	...
	if ($player['timeline_preview'] == 1) {
		...
		// conversão (e pelo backfill gcs_sync_thumbs.php) e servido de lá — o
		// tmb/{VID} local pode nem existir, então não regenerar aqui (evita 500
		// quando as thumbs só existem no bucket).
